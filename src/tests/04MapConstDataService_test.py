...
from vjmap.services import UploadMAPService,OpenMapRequestParams,OpenmapService,MapConstDataService
...
# 获取地图原数据
mapConstDataService=MapConstDataService()
res=mapConstDataService.getConstData(mapid=mapid)
print(res)
