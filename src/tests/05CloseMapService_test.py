...
from vjmap.services import UploadMAPService,OpenMapRequestParams,OpenmapService,CloseMapService
...
# 获取地图原数据
closeMapService=CloseMapService()
res=closeMapService.close(mapid=mapid)
print(res)
